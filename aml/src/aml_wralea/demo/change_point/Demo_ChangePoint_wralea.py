...
__name__ = 'Demo.ChangePoint (gnuplot and aml)'
...
_41439344 = CompositeNodeFactory(name='Dycorinia change point', 
   ...
   31: ('Demo.ChangePoint (gnuplot and aml)', 'angelique_internode_length.seq'),
   ...
   30: [(0, '3')],
   31: [  (  0,
             'PackageData(Demo.ChangePoint (gnuplot and aml), angelique_internode_length.seq)'),
          (1, 'None'),
          (2, 'None')],
   33: [],
   34: [],
...
_41439376 = CompositeNodeFactory(name='Corsican pine change point', 
   ...
   34: ('Demo.ChangePoint (gnuplot and aml)', 'pin_laricio_7x.seq'),
   ...
   32: [],
   33: [],
   34: [  (0, 'PackageData(Demo.ChangePoint (gnuplot and aml), pin_laricio_7x.seq)'),
          (1, 'None'),
          (2, 'None')],
   36: [],
   37: [],
