...
if __name__ == '__main__':
    ...
    setup(name=name,
          ...
          package_dir={namespace+".aml" : "src/openalea/aml",
                       namespace+".aml_wralea" : "src/openalea/aml_wralea",
                       namespace+".aml.amldoc" : "src/openalea/aml/amldoc",
                       namespace+".aml_wralea.wralea" : "src/openalea/aml_wralea/wralea",
                       namespace+".aml_wralea.demo" : "src/openalea/aml_wralea/demo",
                       namespace+".aml_wralea.demo.change_point" : "src/openalea/aml_wralea/demo/change_point", 
                       namespace+".aml_wralea.demo.mtg": "src/openalea/aml_wralea/demo/mtg", 
